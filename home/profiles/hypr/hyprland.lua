...
bind_mod("SHIFT + Print", run("unisic --hotkey record-video"))
bind_mod("CTRL + Print", run("unisic --hotkey ocr-region"))
bind_mod("V", run("voxtype record start"))
bind_mod("V", run("voxtype record stop"), { release = true })
